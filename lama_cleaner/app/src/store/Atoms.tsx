...
export enum AIModel {
  LAMA = 'lama',
  LDM = 'Odmazávání objektů 2',
  ZITS = 'Strukturální odmazávání',
  MAT = 'Odmazávání velkých ploch',
  FCF = 'Textury',
  SD15 = 'sd1.5',
  ANYTHING4 = 'Anything (4)',
  REALISTIC_VISION_1_4 = 'Realistická vize',
  SD2 = 'sd2',
  CV2 = 'cv2',
  Mange = 'manga',
  PAINT_BY_EXAMPLE = 'paint_by_example',
  PIX2PIX = 'Obrázek na obrázek',
}
